...
/datum/addiction/opioids
	name = "opioid"
	withdrawal_stage_messages = list("My body is aching..", "I need some pain relief...", "It aches all over...I need some opioids!")
...
/datum/addiction/maintenance_drugs/withdrawal_stage_3_process(mob/living/carbon/affected_carbon, delta_time)
	...
	if(lums > 0.5)
		...
		affected_human.confused = min(affected_human.confused, 20)
	else
